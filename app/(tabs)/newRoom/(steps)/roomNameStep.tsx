...
import { View, StyleSheet, ScrollView, KeyboardAvoidingView, TouchableWithoutFeedback, Platform, Keyboard } from 'react-native';
        ...
        <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
          ...
          <View style={styles.header}>
            ...
            <ThemedText style={styles.subtitle}>
              Invita a otros usuarios a participar en votaciones que vos generes
            </ThemedText>
          </View>

          <FormStepCard stepNumber={1} instructions="Para comenzar, define un nombre y una descripción (opcional)" />
